...
function _detheme_maybe_update(){
	...
	detheme_check_theme_for_update();
}

function detheme_check_theme_for_update(){
...
function detheme_add_site_transient_update_themes($value){
...
add_filter( 'pre_set_site_transient_update_themes','detheme_add_site_transient_update_themes');
add_action( 'admin_init', '_detheme_maybe_update' );
add_action( 'load-themes.php', 'detheme_check_theme_for_update' );
add_action( 'load-update.php', 'detheme_check_theme_for_update' );
add_action( 'load-update-core.php', 'detheme_check_theme_for_update' );
add_action( 'wp_update_themes', 'detheme_check_theme_for_update' );
...
function _detheme_maybe_plugins_update(){
...
function detheme_add_site_transient_update_plugins($transient){
	$detheme_update = get_site_transient( 'detheme_update_plugins' );
...
function detheme_check_for_update($field, $value="", $existing_value){
...
add_filter( 'pre_set_site_transient_update_plugins','detheme_add_site_transient_update_plugins');
add_action( 'admin_init', '_detheme_maybe_plugins_update' );
