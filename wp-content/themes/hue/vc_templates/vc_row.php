...
if('squeeze.php'==get_page_template_slug($post_id) || 'squeezeboxed.php'==get_page_template_slug($post_id) || 'fullwidth.php'==get_page_template_slug($post_id) || "fullwidth"==get_detheme_sidebar_position()){
    set_query_var('sidebar','nosidebar');
}

$dt_el_id = detheme_get_global_var('dt_el_id');
...
detheme_set_global_var('dt_el_id',$dt_el_id);
...
if(version_compare(WPB_VC_VERSION,'4.8.0','<')){
    ...
    if(''!==$customcss){
        detheme_set_global_style(".".$excss."{".$customcss."}");
    }


    if(''!=$font_color){
        detheme_set_global_style(".".$excss." .dt-counto:after {background-color: ".$font_color." }");
        detheme_set_global_style(".".$excss." h1,.".$excss." h2,.".$excss." h3,.".$excss." h4,.".$excss." h5,.".$excss." h6,.".$excss." .progress_number{color: ".$font_color." }");
    }
    ...
    if('vc_row'==$this->settings['base']){
        ...
        if($expanded){
           ...
           if($columnExpaded && $backgroundExpaded){
                ...
                "<div ".(''!=$el_id?'id="'.$el_id.'" ':'')."class=\"box-container ".$css_class.($video!=''?" has-video":"")."\">".$video."<div ".((vc_is_inline())?" style=\"".$customcss."\" ":"").$style."><div>":
                ...
                $ExpandClass=('nosidebar'==get_query_var('sidebar'))?
                "<div ".(''!=$el_id?'id="'.$el_id.'" ':'')."class=\"box-container ".$css_class.($video!=''?" has-video":"")."\"".$style.">".$video."<div class=\"\"".((vc_is_inline())?" style=\"".$customcss."\" ":"")."><div>":
                "<div ".(''!=$el_id?'id="'.$el_id.'" ':'').((vc_is_inline())?"style=\"".$customcss."\" ":"")." class=\"".$css_class.($video!=''?" has-video":"")."\"".$style.">".$video."<div class=\"\"><div>";
            }elseif($backgroundExpaded && !$columnExpaded){

                $ExpandClass=('nosidebar'==get_query_var('sidebar'))?
                "<div ".(''!=$el_id?'id="'.$el_id.'" ':'')."class=\"box-container ".$css_class.($video!=''?" has-video":"")."\"".$style."><div class=\"container dt-container\" ".((vc_is_inline())?" style=\"".$customcss."\" ":"").">".$video."<div class=\"row\">":
                "<div ".(''!=$el_id?'id="'.$el_id.'" ':'').((vc_is_inline())?"style=\"".$customcss."\" ":"")." class=\"".$css_class.($video!=''?" has-video":"")."\"".$style.">".$video."<div><div>";
            }
...
elseif(version_compare(WPB_VC_VERSION,'4.8.0','>=') && version_compare(WPB_VC_VERSION,'4.11','<')){
    ...
    if('vc_row'==$this->settings['base']){
        ...
        if($expanded){
           ...
           if($columnExpaded && $backgroundExpaded){
                $ExpandClass=('nosidebar'==get_query_var('sidebar'))?
                "<div ".(''!=$el_id?'id="'.$el_id.'" ':'').((vc_is_inline())?"style=\"".$customcss."\" ":"")."class=\"box-container ".$css_class.($video!=''?" has-video":"")."\">".$video."<div class=\"\"".$parallax."><div>":
...
/* version  4.11 */
    ...
    if('vc_row'==$this->settings['base']){
        ...
        if($expanded){
           ...
           if($columnExpaded && $backgroundExpaded){
                $ExpandClass=('nosidebar'==get_query_var('sidebar'))?
                "<div ".(''!=$el_id?'id="'.$el_id.'" ':'').((vc_is_inline())?"style=\"".$customcss."\" ":"")."class=\"box-container ".$css_class.($video!=''?" has-video":"")."\">".$video."<div class=\" not-flex\"".$parallax."><div class=\"inner-flex\">":
