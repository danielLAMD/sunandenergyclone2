...
class DethemeReduxFramework_typography extends DethemeReduxFramework{
    ...
    if ($this->field['font-family'] == true):
          ...
          echo '<div id="'.$this->field['id'].'" class="redux-typography-container" data-id="'.$this->field['id'].'" data-units="'.$unit.'">';
              ...
              echo '<select data-placeholder="'.esc_attr__('Font family','redux-framework').'" class="redux-typography redux-typography-family '.$this->field['class'].'" id="'.$this->field['id'].'-family" data-id="'.$this->field['id'].'" data-value="'.$fontFamily[0].'">';
              ...
              if ( $this->field['google'] == true && !empty( $this->args['google_api_key'] ) ) {
                echo '<optgroup label="'.esc_html__('Standard Fonts', 'redux-framework').'">';  
              }
              ...
              if ($this->field['google'] == true && !empty( $this->args['google_api_key'] ) ) {
                  ...
                  if ( !isset( $this->googleFontHTML ) && !empty( $this->googleFontHTML ) ) {
                    echo wp_kses_data($this->googleFontHTML);
            ...
            if ($this->field['font-style'] == true || $this->field['font-weight'] == true):
              ...
              $style = $this->value['font-weight'].$this->value['font-style'];
                ...
                echo '<select data-placeholder="'.esc_attr__('Style','redux-framework').'" class="redux-typography redux-typography-style select'.$this->field['class'].'" original-title="'.esc_attr__('Font style','redux-framework').'" id="'. $this->field['id'].'_style" data-id="'.$this->field['id'].'" data-value="'.$style.'">';
            ...
            if ($this->field['subsets'] == true && $this->field['google'] == true):
                ...
                echo '<select data-placeholder="'.esc_attr__('Subsets','redux-framework').'" class="redux-typography redux-typography-subsets'.$this->field['class'].'" original-title="'.esc_attr__('Font script','redux-framework').'"  id="'.$this->field['id'].'-subsets" name="'.$this->args['opt_name'].'['.$this->field['id'].'][subsets]" data-value="'.$this->value['subsets'].'" data-id="'.$this->field['id'].'" >';
            ...
            if ($this->field['font-family'] == true && $this->field['google'] == true) { 
              // Set a flag so we know to set a header style or not
                ...
                if ($this->field['font-backup'] == true) {
                  ...
                  echo '<select data-placeholder="'.esc_attr__('Backup Font Family','redux-framework').'" name="'.$this->args['opt_name'].'['.$this->field['id'].'][font-backup]" class="redux-typography redux-typography-family-backup '.$this->field['class'].'" id="'.$this->field['id'].'-family-backup" data-id="'.$this->field['id'].'" data-value="'.$this->value['font-backup'].'">';
                  echo '<option data-google="false" data-details="" value=""></option>';
                  foreach ($this->field['fonts'] as $i=>$family) {
            ...
            if ($this->field['color'] == true):
                ...
                echo '<input data-default-color="'.$default.'" class="redux-color redux-typography-color'.$this->field['class'].'" original-title="'.esc_attr__('Font color','redux-framework').'" id="'.$this->field['id'].'-color" name="'.$this->args['opt_name'].'['.$this->field['id'].'][color]" type="text" value="'. $this->value['color'] .'" data-id="'.$this->field['id'].'" />';
            endif;
    ...
    */
    ...
    function getGoogleFonts() {
        ...
        $gfonts = '<optgroup label="'.esc_html__('Google Webfonts', 'redux-framework').'">';
