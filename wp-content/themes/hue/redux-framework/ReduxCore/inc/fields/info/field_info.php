...
// Don't duplicate me!
if( !class_exists( 'DethemeReduxFramework_info' ) ) {
     ...
     * @since       1.0.0
     */
    class DethemeReduxFramework_info extends DethemeReduxFramework {
        ...
        public function render() {
            ...
            echo '</td></tr></table><div id="' . $this->field['id'] . '" class="' . $this->field['style'] . $this->field['class'] . '">';
            	...
            	if ( !empty($this->field['raw_html']) && $this->field['raw_html'] ) {
            		echo wp_kses_data($this->field['desc']);
            	} else {
                    ...
                    if (isset($this->field['raw']) && !empty($this->field['raw'])) {
                        echo wp_kses_data($this->field['raw']);    
                    }
        ...
        public function enqueue() {
            ...
            wp_enqueue_style(
                ...
                DethemeReduxFramework::$_url . 'inc/fields/info/field_info.css',
                "",
                true
            );
