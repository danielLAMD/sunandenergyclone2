...
// Don't duplicate me!
if( !class_exists( 'DethemeReduxFramework_media' ) ) {
     ...
     * @since       1.0.0
     */
    class DethemeReduxFramework_media extends DethemeReduxFramework {
        ...
        public function render() {
            ...
            echo '<img class="redux-option-image" id="image_' . $this->field['id'] . '" src="' . esc_url($this->value['thumbnail']) . '" alt="" target="_blank" rel="external" />';
            echo '</a>';
            echo '</div>';
